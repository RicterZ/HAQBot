...
_TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "zh_CN": {
        ...
        "multiple_entities_found": "⚠️ 发现 {count} 个同名实体（名称: {name}），将控制第一个: {first}",
        ...
        "climate_command_description": "控制空调设备（支持实体ID、友好名称或别名，设置模式：制冷/制热/通风/关闭，设置温度）",
        ...
        "refresh_command_description": "刷新实体缓存（重新加载实体、设备、区域和别名信息）",
    ...
    "en_US": {
        ...
        "multiple_entities_found": "⚠️ Found {count} entities with same name ({name}), will control the first one: {first}",
        ...
        "turnon_command_description": "Turn on specified device(s) (supports entity_id or friendly_name, can control multiple)",
        "turnoff_command_description": "Turn off specified device(s) (supports entity_id or friendly_name, can control multiple)",
        "toggle_command_description": "Toggle specified device(s) state (supports entity_id or friendly_name, can control multiple)",
        ...
        "climate_command_description": "Control climate device (supports entity_id or friendly_name, set mode: cool/heat/fan_only/off, set temperature)",
        ...
        "mode_off": "Off",
        "search_command_description": "Fuzzy search entities (supports entity_id or friendly_name)",
        "search_usage": "Usage: /search <query>",
        "refresh_command_description": "Refresh entity cache (reload entities, devices, and areas)",
