...
_TRANSLATIONS: Dict[str, Dict[str, str]] = {
    ...
    "en_US": {
        ...
        "climate_command_description": "Control climate device (supports entity_id, friendly_name, or alias, set mode: cool/heat/fan_only/off, set temperature)",
        ...
        "refresh_command_description": "Refresh entity cache (reload entities, devices, areas, and aliases)",
